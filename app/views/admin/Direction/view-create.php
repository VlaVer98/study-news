...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Добавить руководителя</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action = "/admin/direction/create" role="form" id="quickForm" method="post">
                    <div class="card-body col-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="position" id="position" class="form-control" value = "" placeholder="Должность">
                        </div>
                        <div class="form-group">
                            <label for="contact">Контакты</label>
                            <input type="text" name="contact" id="contact" class="form-control" value = "" placeholder="Контакты">
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
