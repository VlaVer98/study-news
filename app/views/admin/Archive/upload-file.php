...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-10">
        <h1 class="m-0 text-dark"></a>Добавить новый файл</h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
...
<section class="content">
  <div class="container-fluid">
    <!-- Main row -->
        <div class="row">
          <div class="col-md-12">
            <form action = "/admin/archive/upload-file" role="form" id="quickForm" method="post">
              <div class="card-body">
...
<script>
  ...
  $("#dropzone2 .card-body").dropzone({ 
    ...
    dictMaxFilesExceeded: "Можно загрузить только 10 файлов!",
    removedfile: function(file) {
      var name_file = file.upload.filename;
      $.ajax({
        url: "/admin/uploader/delete-file",
        method: "GET",
        data: {name: name_file}
      });
      //console.log(file)
