...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <form action = "/admin/teacher/edit" role="form" id="quickForm" method="post">
          <input type="text" name="id" value="<?=$teacher['id']?>" hidden="">
          <div class="card-body col-6">
            <div class="form-group">
              <label for="surname">Фамилия</label>
              <input type="text" name="surname" id="surname" class="form-control" value = "<?=$teacher['surname']?>" placeholder="Фамилия">
            </div>
             <div class="form-group">
                <label for="name">Имя</label>
                <input type="text" name="name" id="name" class="form-control" value = "<?=$teacher['name']?>" placeholder="Имя">
             </div>
              <div class="form-group">
                  <label for="patronymic">Отчество</label>
                  <input type="text" name="patronymic" id="patronymic" class="form-control" value = "<?=$teacher['patronymic']?>" placeholder="Отчество">
              </div>
              <div class="row">
                  <div class="col-md-12">
                      <div class="card-body">
                          ...
                          <div class="server_img" id="server_img" hidden><?= $teacher['img'] ?></div>
                      </div>
                      <!-- /.card -->
                  </div>
              </div>
